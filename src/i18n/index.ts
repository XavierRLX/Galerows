...
const resources = {
  'pt-BR': { common: ptCommon, hub: ptHub, 'nem-ferrando': ptNemFerrando, 'impostor-da-palavra': ptImpostorDaPalavra, taboo: ptTaboo, 'quem-sou-eu': ptQuemSouEu },
  'en-US': { common: enCommon, hub: enHub, 'nem-ferrando': enNemFerrando, 'impostor-da-palavra': enImpostorDaPalavra, taboo: enTaboo, 'quem-sou-eu': enQuemSouEu },
  'es-419': { common: esCommon, hub: esHub, 'nem-ferrando': esNemFerrando, 'impostor-da-palavra': esImpostorDaPalavra, taboo: esTaboo, 'quem-sou-eu': esQuemSouEu },
}
