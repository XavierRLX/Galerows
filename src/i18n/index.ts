...
const resources = {
  'pt-BR': { common: ptCommon, hub: ptHub, 'nem-ferrando': ptNemFerrando, 'impostor-da-palavra': ptImpostorDaPalavra, taboo: ptTaboo },
  'en-US': { common: enCommon, hub: enHub, 'nem-ferrando': enNemFerrando, 'impostor-da-palavra': enImpostorDaPalavra, taboo: enTaboo },
  'es-419': { common: esCommon, hub: esHub, 'nem-ferrando': esNemFerrando, 'impostor-da-palavra': esImpostorDaPalavra, taboo: esTaboo },
}
