...
export function QuemSouEuResultScreen() {
  ...
  return <div className="min-h-dvh pb-10"><AppReviewCheckpoint matchId={session.id} /><Header title={t('result.title')} /><section className="px-5 py-8 text-center"><Trophy className="mx-auto text-cyan-200" size={64} /><h1 className="mt-4 text-3xl font-black">{t('result.heading')}</h1><p className="mt-2 text-slate-400">{t('result.description')}</p>
